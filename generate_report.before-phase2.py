...
def generate_styleguide(tokens=TOKENS):
    ...
    TYPE_USAGE = {
        ...
        "h3":         "Заголовки блоков внутри карточек (.cell), .title-area h3",
        "body":       "Body, h4, .meta, .filters label, .grain-btn, .delta, .country-row",
        "caption":    "<th>/<td>, .kpi-label, .kpi-bench, .header-meta, .agg-tag, datalabels",
        "chart-meta": "Подписи делений осей и легенда на графиках",
    }
    SPACE_USAGE = {
...
<head>
    ...
    <style>
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; font-family: inherit; }}
        ...
        .tab-btn {{ padding: 6px 14px; border-radius: var(--r-md); font-size: var(--fs-body); font-weight: var(--fw-semibold); border: 1px solid var(--bg-border); cursor: pointer; background: var(--bg-card); color: var(--tx-secondary); }}
        ...
        .grain-sq {{ width: 32px; height: 32px; display: inline-flex; align-items: center; justify-content: center; font-size: var(--fs-body); font-weight: var(--fw-bold); background: var(--bg-muted); color: var(--tx-secondary); border-radius: var(--r-md); }}
...
<head>
    ...
    <style>
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; font-family: inherit; }}
        ...
        h4 {{ font-size: var(--fs-body); font-weight: var(--fw-semibold); margin: var(--sp-3) 0 6px; color: var(--tx-secondary); }}
        .meta {{ color: var(--tx-secondary); font-size: var(--fs-body); margin-bottom: var(--sp-3); }}
        ...
        .brand {{ font-size: var(--fs-h2); font-weight: var(--fw-bold); color: var(--tx-primary); }}
        .header-meta {{ font-size: var(--fs-caption); color: var(--tx-secondary); line-height: 1.3; }}
        .header-right {{ display: flex; align-items: center; gap: var(--sp-3); }}
        .grain-nav {{ display: flex; gap: 2px; }}
        .grain-sq {{
            width: 32px; height: 32px; display: flex; align-items: center; justify-content: center;
            font-size: var(--fs-body); font-weight: var(--fw-bold); background: var(--bg-muted); color: var(--tx-secondary);
        ...
        */
        ...
        /* Data tables */
        .data-table {{ width: 100%; border-collapse: collapse; background: var(--bg-card); border-radius: var(--r-xl); overflow: hidden; box-shadow: var(--sh-card); }}
        .data-table th {{ background: var(--bg-inverse); color: var(--tx-ondark); padding: var(--sp-2) var(--sp-3); font-size: var(--fs-caption); text-align: left; font-weight: var(--fw-semibold); cursor: pointer; user-select: none; }}
